...
var loadLazyContent,lazyLoadType,loadLazyImages,retainCrossFrames,mergeCSSImages,removeUnsavedURLs,removeElements,rehideElements,includeInfoBar,includeSummary,formatHTML;
...
function extractHTML(depth,frame,element,crossframe,nosrcframe,framekey,parentpreserve,indent)
{
    ...
    var voidElements = ["area","base","br","col","command","embed","frame","hr","img","input","keygen","link","menuitem","meta","param","source","track","wbr"];  /* W3C HTML5 4.3 Elements + menuitem */
    var retainElements = ["html","head","body","base","command","link","meta","noscript","script","style","template","title"];
    var hiddenElements = ["area","base","datalist","head","link","meta","param","rp","script","source","style","template","track","title"];  /* W3C HTML5 10.3.1 Hidden Elements */
                ...
                if (element.childNodes[i] != null)  /* in case web page not fully loaded before extracting */
                {
                    ...
                    else if (element.childNodes[i].nodeType == 3)  /* text node */
                    {
                        ...
                        if (pageType > 0 && formatHTML && depth == 0)
                        {
                            ...
                            {
                                if (element.childNodes[i+1].textContent.indexOf("SAVE PAGE VIP") >= 0) continue;
                            }
                    ...
                    else if (element.childNodes[i].nodeType == 8)  /* comment node */
                    {
                        ...
                        if (text.indexOf("SAVE PAGE VIP") >= 0) continue;
